...
export default function AddItem({ id, showModal, onHide }) {
  ...
  const onSubmit = async (data) => {
    try {
      setApiError(null);
      await itemService.post(data, id);
      reset({ ...data });
    } catch (err) {
      ...
      if (apiErrors && typeof apiErrors === "object") {
        ...
        setApiError(apiErrors || "Item creation failed");
      }
    }
  };
  ...
  return (
    <Modal show={showModal} onHide={onHide} centered>
      <Modal.Header closeButton>
        <Modal.Title>
          <h4 className="p-0 m-0 modal-title">Add new Item</h4>
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
